...
public class AllYamamoriDownloader : IDisposable {
...
$client = New-Object AllYamamoriDownloader
try {
    ...
    Write-Output "Checking all $($msgIds.Count) messages for ANY attachments with numeric names..."
            ...
            if ($boundaryMatch.Success) {
                ...
                foreach ($p in $parts) {
                    ...
                    if ($fnMatch.Success) {
                        ...
                        # Match any PDF where the filename starts with a number (e.g. 1950.pdf, 2078-2081.pdf, 2101.pdf, 2245.pdf, etc.)
                            ...
                            if ($contentIdx -ge 0) {
                                ...
                                try {
                                    ...
                                    if ($fileBytes.Length -gt 1000) {
                                        ...
                                        Write-Output ">>> [SAVED] $filename -> Aug/ ($($fileBytes.Length) bytes)"
                                    }
                                } catch {}
                            }
                        }
