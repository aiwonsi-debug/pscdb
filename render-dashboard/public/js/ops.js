document.write(new Date(document.lastModified).toLocaleString("th-TH", { year: "numeric", month: "short", day: "numeric", hour: "2-digit", minute: "2-digit" }) + " น.");</script></span></div>
      ...
      <div class="cal-week-box" style="background: rgba(15, 23, 42, 0.7); border: 1px solid #35393b; border-radius: 10px; padding: 12px; margin-bottom: 10px;">
        ...
        <div class="cal-event-item cal-aft" style="padding:6px 0; border-bottom: 1px dashed rgba(255,255,255,0.04); font-size:12px;">
          <b style="color:#f8fafc;">03/09 (พฤ.):</b> <span class="badge badge-salaya" style="font-size:9.5px;">AFT</span> <span style="color:#f59e0b; font-weight:600;">(รอบบ่าย)</span> กะหล่ำ 3,000 kg, หอมใหญ่ 1,100 kg
        </div>
        <div class="cal-event-item cal-tns" style="padding:6px 0; border-bottom: 1px dashed rgba(255,255,255,0.04); font-size:12px;">
          <b style="color:#f8fafc;">03/09 (พฤ.):</b> <span class="badge badge-tns" style="font-size:9.5px;">TNS</span> แครอท 1,000 kg, กะหล่ำ 700 kg, ต้นหอม 200 kg
        </div>
        <div class="cal-event-item cal-tns" style="padding:6px 0; border-bottom: 1px dashed rgba(255,255,255,0.04); font-size:12px;">
          <b style="color:#f8fafc;">04/09 (ศ.):</b> <span class="badge badge-tns" style="font-size:9.5px;">TNS</span> แครอท 600 kg, กะหล่ำ 600 kg
        </div>
        <div class="cal-event-item cal-aft" style="padding:6px 0; border-bottom: 1px dashed rgba(255,255,255,0.04); font-size:12px;">
          <b style="color:#f8fafc;">05/09 (ส.):</b> <span class="badge badge-salaya" style="font-size:9.5px;">AFT</span> กะหล่ำ 3,000 kg (+1,000), แครอท 630 kg, หอมใหญ่ 500 kg
        </div>
        <div class="cal-event-item cal-yamamori" style="padding:6px 0; border-bottom: 1px dashed rgba(255,255,255,0.04); font-size:12px;">
          <b style="color:#f8fafc;">05/09 (ส.):</b> <span class="badge badge-warning" style="font-size:9.5px;">Yamamori</span> แครอท 180 kg, หอมใหญ่ 625 kg (PO2357)
        </div>
        <div class="cal-event-item cal-tns" style="padding:6px 0; font-size:12px;">
          <b style="color:#f8fafc;">05/09 (ส.):</b> <span class="badge badge-tns" style="font-size:9.5px;">TNS</span> แครอท 1,000 kg
        </div>
      </div>
      ...
      <div class="cal-week-box" style="background: rgba(15, 23, 42, 0.7); border: 1px solid #35393b; border-radius: 10px; padding: 12px; margin-bottom: 10px;">
        ...
        <div class="cal-event-item cal-aft" style="padding:6px 0; border-bottom: 1px dashed rgba(255,255,255,0.04); font-size:12px;">
          <b style="color:#f8fafc;">07/09 (จ.):</b> <span class="badge badge-salaya" style="font-size:9.5px;">AFT</span> <span style="color:#f59e0b; font-weight:600;">(รอบบ่าย)</span> กะหล่ำ 3,000 kg, หอม 1,000 kg, <b style="color:#38bdf8;">Sample RD แครอท 4 kg</b>
        </div>
        <div class="cal-event-item cal-tns" style="padding:6px 0; border-bottom: 1px dashed rgba(255,255,255,0.04); font-size:12px;">
          <b style="color:#f8fafc;">07/09 (จ.):</b> <span class="badge badge-tns" style="font-size:9.5px;">TNS</span> <b style="color:#ec4899;">หอมแดง 500 kg (ป้าผา)</b>, แครอท 700 kg
        </div>
        <div class="cal-event-item cal-aft" style="padding:6px 0; border-bottom: 1px dashed rgba(255,255,255,0.04); font-size:12px;">
          <b style="color:#f8fafc;">08/09 (อ.):</b> <span class="badge badge-salaya" style="font-size:9.5px;">AFT</span> กะหล่ำ 2,500 kg, หอมใหญ่ 1,500 kg <span style="color:#94a3b8; font-size:11px;">(รอบศาลายา 8 ตัน เลื่อนเป็นเข้า 10/09)</span>
        </div>
        <div class="cal-event-item cal-tns" style="padding:6px 0; border-bottom: 1px dashed rgba(255,255,255,0.04); font-size:12px;">
          <b style="color:#f8fafc;">08/09 (อ.):</b> <span class="badge badge-tns" style="font-size:9.5px;">TNS</span> แครอท 1,000 kg, กะหล่ำ 700 kg, ขิง 150 kg
        </div>
        <div class="cal-event-item cal-tns" style="padding:6px 0; border-bottom: 1px dashed rgba(255,255,255,0.04); font-size:12px;">
          <b style="color:#f8fafc;">09/09 (พ.):</b> <span class="badge badge-tns" style="font-size:9.5px;">TNS</span> แครอท 800 kg, กะหล่ำ 600 kg
        </div>
        <div class="cal-event-item cal-aft" style="padding:6px 0; border-bottom: 1px dashed rgba(255,255,255,0.04); font-size:12px;">
          <b style="color:#f8fafc;">10/09 (พฤ.):</b> <span class="badge badge-salaya" style="font-size:9.5px;">AFT</span> กะหล่ำ 2,000 kg, หอมใหญ่ 2,000 kg
        </div>
        <div class="cal-event-item cal-aft" style="padding:6px 0; border-bottom: 1px dashed rgba(255,255,255,0.04); font-size:12px;">
          <b style="color:#f8fafc;">10/09 (พฤ.):</b> <span class="badge badge-salaya" style="font-size:9.5px;">ศาลายา</span> <b style="color:#f59e0b;">กะหล่ำปลี 8,000 kg (เข้าศาลายา - เลื่อนจาก 08/09)</b>
        </div>
        <div class="cal-event-item cal-yamamori" style="padding:6px 0; border-bottom: 1px dashed rgba(255,255,255,0.04); font-size:12px;">
          <b style="color:#f8fafc;">10/09 (พฤ.):</b> <span class="badge badge-warning" style="font-size:9.5px;">Yamamori</span> แครอท 136 kg, หอมใหญ่ 1,150 kg (PO2358)
        </div>
        <div class="cal-event-item cal-tns" style="padding:6px 0; border-bottom: 1px dashed rgba(255,255,255,0.04); font-size:12px;">
          <b style="color:#f8fafc;">10/09 (พฤ.):</b> <span class="badge badge-tns" style="font-size:9.5px;">TNS</span> แครอท 1,000 kg, กะหล่ำ 700 kg, ต้นหอม 200 kg
        </div>
        <div class="cal-event-item cal-tns" style="padding:6px 0; border-bottom: 1px dashed rgba(255,255,255,0.04); font-size:12px;">
          <b style="color:#f8fafc;">11/09 (ศ.):</b> <span class="badge badge-tns" style="font-size:9.5px;">TNS</span> แครอท 600 kg, กะหล่ำ 600 kg
        </div>
        <div class="cal-event-item cal-aft" style="padding:6px 0; border-bottom: 1px dashed rgba(255,255,255,0.04); font-size:12px;">
          <b style="color:#f8fafc;">12/09 (ส.):</b> <span class="badge badge-salaya" style="font-size:9.5px;">AFT</span> กะหล่ำ 2,500 kg, แครอท 630 kg, หอมใหญ่ 1,000 kg
        </div>
        <div class="cal-event-item cal-tns" style="padding:6px 0; font-size:12px;">
          <b style="color:#f8fafc;">12/09 (ส.):</b> <span class="badge badge-tns" style="font-size:9.5px;">TNS</span> แครอท 1,000 kg
        </div>
      </div>
      ...
      <div class="cal-week-box" style="background: rgba(15, 23, 42, 0.7); border: 1px solid #35393b; border-radius: 10px; padding: 12px; margin-bottom: 10px;">
        ...
        <div class="cal-event-item cal-aft" style="padding:6px 0; border-bottom: 1px dashed rgba(255,255,255,0.04); font-size:12px;">
          <b style="color:#f8fafc;">14/09 (จ.):</b> <span class="badge badge-salaya" style="font-size:9.5px;">AFT</span> กะหล่ำ 2,500 kg, หอมใหญ่ 1,500 kg
        </div>
        <div class="cal-event-item cal-yamamori" style="padding:6px 0; border-bottom: 1px dashed rgba(255,255,255,0.04); font-size:12px;">
          <b style="color:#f8fafc;">14/09 (จ.):</b> <span class="badge badge-warning" style="font-size:9.5px;">Yamamori</span> แครอท 136 kg, หอมใหญ่ 605 kg (PO2424)
        </div>
        <div class="cal-event-item cal-tns" style="padding:6px 0; border-bottom: 1px dashed rgba(255,255,255,0.04); font-size:12px;">
          <b style="color:#f8fafc;">14/09 (จ.):</b> <span class="badge badge-tns" style="font-size:9.5px;">TNS</span> แครอท 800 kg, กะหล่ำ 600 kg
        </div>
        <div class="cal-event-item cal-aft" style="padding:6px 0; border-bottom: 1px dashed rgba(255,255,255,0.04); font-size:12px;">
          <b style="color:#f8fafc;">15/09 (อ.):</b> <span class="badge badge-salaya" style="font-size:9.5px;">AFT</span> กะหล่ำ 2,500 kg, หอมใหญ่ 1,500 kg
        </div>
        <div class="cal-event-item cal-tns" style="padding:6px 0; border-bottom: 1px dashed rgba(255,255,255,0.04); font-size:12px;">
          <b style="color:#f8fafc;">15/09 (อ.):</b> <span class="badge badge-tns" style="font-size:9.5px;">TNS</span> แครอท 1,000 kg, กะหล่ำ 700 kg, ขิง 150 kg
        </div>
        <div class="cal-event-item cal-yamamori" style="padding:6px 0; border-bottom: 1px dashed rgba(255,255,255,0.04); font-size:12px;">
          <b style="color:#f8fafc;">16/09 (พ.):</b> <span class="badge badge-warning" style="font-size:9.5px;">Yamamori</span> หอมใหญ่ 920 kg (PO2425)
        </div>
        <div class="cal-event-item cal-tns" style="padding:6px 0; border-bottom: 1px dashed rgba(255,255,255,0.04); font-size:12px;">
        ...
        <div class="cal-event-item cal-aft" style="padding:6px 0; border-bottom: 1px dashed rgba(255,255,255,0.04); font-size:12px;">
          <b style="color:#f8fafc;">17/09 (พฤ.):</b> <span class="badge badge-salaya" style="font-size:9.5px;">AFT</span> กะหล่ำ 2,500 kg, หอมใหญ่ 1,000 kg
        </div>
        <div class="cal-event-item cal-tns" style="padding:6px 0; border-bottom: 1px dashed rgba(255,255,255,0.04); font-size:12px;">
          <b style="color:#f8fafc;">17/09 (พฤ.):</b> <span class="badge badge-tns" style="font-size:9.5px;">TNS</span> แครอท 1,000 kg, กะหล่ำ 700 kg, ต้นหอม 150 kg
        </div>
        <div class="cal-event-item cal-tns" style="padding:6px 0; border-bottom: 1px dashed rgba(255,255,255,0.04); font-size:12px;">
          <b style="color:#f8fafc;">18/09 (ศ.):</b> <span class="badge badge-tns" style="font-size:9.5px;">TNS</span> แครอท 600 kg, กะหล่ำ 600 kg
        </div>
        <div class="cal-event-item cal-aft" style="padding:6px 0; border-bottom: 1px dashed rgba(255,255,255,0.04); font-size:12px;">
          <b style="color:#f8fafc;">19/09 (ส.):</b> <span class="badge badge-salaya" style="font-size:9.5px;">AFT</span> กะหล่ำ 2,000 kg, แครอท 630 kg, หอมใหญ่ 500 kg
        </div>
        <div class="cal-event-item cal-tns" style="padding:6px 0; font-size:12px;">
          <b style="color:#f8fafc;">19/09 (ส.):</b> <span class="badge badge-tns" style="font-size:9.5px;">TNS</span> แครอท 1,000 kg
        </div>
      </div>
      ...
      <div class="cal-week-box" style="background: rgba(15, 23, 42, 0.7); border: 1px solid #35393b; border-radius: 10px; padding: 12px;">
        ...
        <div class="cal-event-item cal-aft" style="padding:6px 0; border-bottom: 1px dashed rgba(255,255,255,0.04); font-size:12px;">
          <b style="color:#f8fafc;">21/09 (จ.):</b> <span class="badge badge-salaya" style="font-size:9.5px;">AFT</span> กะหล่ำ 2,500 kg, หอมใหญ่ 1,500 kg
        </div>
        <div class="cal-event-item cal-tns" style="padding:6px 0; border-bottom: 1px dashed rgba(255,255,255,0.04); font-size:12px;">
          <b style="color:#f8fafc;">21/09 (จ.):</b> <span class="badge badge-tns" style="font-size:9.5px;">TNS</span> <b style="color:#ec4899;">หอมแดง 500 kg (ป้าผา)</b>, แครอท 800 kg
        </div>
        <div class="cal-event-item cal-aft" style="padding:6px 0; border-bottom: 1px dashed rgba(255,255,255,0.04); font-size:12px;">
          <b style="color:#f8fafc;">22/09 (อ.):</b> <span class="badge badge-salaya" style="font-size:9.5px;">AFT</span> กะหล่ำ 2,500 kg, หอมใหญ่ 1,500 kg
        </div>
        <div class="cal-event-item cal-tns" style="padding:6px 0; border-bottom: 1px dashed rgba(255,255,255,0.04); font-size:12px;">
          <b style="color:#f8fafc;">22/09 (อ.):</b> <span class="badge badge-tns" style="font-size:9.5px;">TNS</span> แครอท 1,000 kg, กะหล่ำ 700 kg, ขิง 150 kg
        </div>
        <div class="cal-event-item cal-aft" style="padding:6px 0; border-bottom: 1px dashed rgba(255,255,255,0.04); font-size:12px;">
          <b style="color:#f8fafc;">24/09 (พฤ.):</b> <span class="badge badge-salaya" style="font-size:9.5px;">AFT</span> กะหล่ำ 2,500 kg, หอมใหญ่ 1,000 kg
        </div>
        <div class="cal-event-item cal-tns" style="padding:6px 0; border-bottom: 1px dashed rgba(255,255,255,0.04); font-size:12px;">
          <b style="color:#f8fafc;">24/09 (พฤ.):</b> <span class="badge badge-tns" style="font-size:9.5px;">TNS</span> แครอท 1,000 kg, กะหล่ำ 700 kg, ต้นหอม 200 kg
        </div>
        <div class="cal-event-item cal-aft" style="padding:6px 0; border-bottom: 1px dashed rgba(255,255,255,0.04); font-size:12px;">
          <b style="color:#f8fafc;">26/09 (ส.):</b> <span class="badge badge-salaya" style="font-size:9.5px;">AFT</span> กะหล่ำ 2,500 kg, แครอท 630 kg, หอมใหญ่ 1,000 kg
        </div>
        <div class="cal-event-item cal-tns" style="padding:6px 0; border-bottom: 1px dashed rgba(255,255,255,0.04); font-size:12px;">
          <b style="color:#f8fafc;">26/09 (ส.):</b> <span class="badge badge-tns" style="font-size:9.5px;">TNS</span> แครอท 1,000 kg
        </div>
        <div class="cal-event-item cal-aft" style="padding:6px 0; border-bottom: 1px dashed rgba(255,255,255,0.04); font-size:12px;">
          <b style="color:#f8fafc;">28/09 - 30/09:</b> <span class="badge badge-salaya" style="font-size:9.5px;">AFT</span> ส่ง 28/09 (กะหล่ำ 2.5t, หอม 1.5t) & 29/09 (กะหล่ำ 2.5t, หอม 1.5t)
        </div>
        <div class="cal-event-item cal-tns" style="padding:6px 0; font-size:12px;">
          <b style="color:#f8fafc;">28/09 - 30/09:</b> <span class="badge badge-tns" style="font-size:9.5px;">TNS</span> ส่งทุกวัน 28, 29, 30 ก.ย. ครบ 24 รอบประจำเดือน
        </div>
      </div>
